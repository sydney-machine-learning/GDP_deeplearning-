...
np.savetxt('results/y_predicttest_meanstd_deu_.csv', y_predicttest_meanstd, delimiter = ',', fmt='%f')

np.savetxt('results/results_summary_deu_.csv', results_combined, delimiter = ',', fmt='%f')  # this can be fixed later so results are all saved for each grid