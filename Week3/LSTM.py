...
for i in df.columns:
	...
	np.savetxt('results/y_predicttest_meanstd'+i+'_.csv', y_predicttest_meanstd, delimiter = ',', fmt='%f')

	np.savetxt('results/results_summary'+i+'_.csv', results_combined, delimiter = ',', fmt='%f')  # this
